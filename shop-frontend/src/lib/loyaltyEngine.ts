...
export const MEMBERSHIP_TIERS: Record<MembershipTier, TierBenefit> = {
  BRONZE: {
    ...
    badgeBorder: 'border-amber-300/80 dark:border-amber-700/60',
  ...
  GOLD: {
    ...
    badgeBorder: 'border-amber-400/90 dark:border-amber-600/70',
  ...
  PLATINUM: {
    tier: 'PLATINUM',
    labelKm: 'ប្លាទីន VIP',
    labelEn: 'Platinum VIP',
    minSpend: 1000,
    pointsMultiplier: 2.0,
    discountPercentage: 5,
    badgeBg: 'bg-indigo-500/15 dark:bg-indigo-500/25',
    badgeText: 'text-indigo-800 dark:text-indigo-300',
    badgeBorder: 'border-indigo-400/90 dark:border-indigo-600/70',
