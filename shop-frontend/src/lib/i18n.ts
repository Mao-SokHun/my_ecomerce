...
const messages: Record<AppLanguage, Record<string, string>> = {
  km: {
    ...
    telegramLoginSuccess: 'ចូល Telegram ជោគជ័យ',
    telegramLoginFailed: 'ចូល Telegram បរាជ័យ',
    ...
    couponDiscount: 'បញ្ចុះតម្លៃ (Coupon: {code})',
    couponDiscountNoCode: 'បញ្ចុះតម្លៃ (Coupon)',
  ...
  en: {
    ...
    telegramLoginSuccess: 'Telegram login successful',
    ...
    couponDiscount: 'Discount (Coupon: {code})',
    couponDiscountNoCode: 'Discount (Coupon)',
  ...
  zh: {
    ...
    telegramLoginSuccess: 'Telegram 登录成功',
    ...
    totalPaid: '已付总额',
    couponDiscount: '优惠折扣（优惠码：{code}）',
    couponDiscountNoCode: '优惠折扣（优惠码）',
