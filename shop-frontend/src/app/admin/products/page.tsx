  ...
  return (
    ...
    >
      ...
      <div className="rounded-xl sm:rounded-2xl border border-slate-200/80 dark:border-surface-750 bg-white dark:bg-surface-900 shadow-2xs p-3 sm:p-3.5 space-y-2.5">
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 min-w-[240px]">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-9 text-sm rounded-xl bg-slate-50 dark:bg-surface-800 border border-slate-200 dark:border-surface-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition shadow-inner"
            />
            {search && (
              <button
                type="button"
          ...
          <div className="flex items-center gap-2.5 shrink-0 flex-wrap sm:flex-nowrap">
            ...
            <button
              type="button"
              onClick={openCreate}
              className="inline-flex items-center justify-center gap-2 px-4.5 h-11 rounded-xl bg-gradient-to-r from-primary-600 via-indigo-600 to-violet-600 hover:from-primary-700 hover:to-violet-700 text-white font-bold text-sm shadow-sm shadow-primary-500/25 transition-all duration-200 active:scale-95 shrink-0"
            >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-slate-100 dark:border-surface-800">
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            <span className="text-xs sm:text-sm font-bold text-slate-500 dark:text-slate-400 mr-1 flex items-center gap-1.5">
            ...
            {(['all', 'featured', 'low_stock', 'out_of_stock', 'active', 'inactive'] as const).map((mode) => (
              <button
                ...
                className={`text-xs sm:text-sm px-3.5 py-1.5 sm:py-2 rounded-xl font-bold transition-all duration-150 flex items-center gap-2 ${
                  filterMode === mode
