        ...
        <div className="p-3.5 border-b border-slate-100 dark:border-slate-800/90 shrink-0 space-y-2.5 bg-slate-50/50 dark:bg-[#0f172a]/70">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-8.5 pl-8.5 pr-8 text-xs rounded-xl bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition shadow-inner"
            />
            {searchQuery && (
              <button
                type="button"
