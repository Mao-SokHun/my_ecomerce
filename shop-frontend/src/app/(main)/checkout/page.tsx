...
import { CheckCircle, ChevronRight, ShoppingBag, CreditCard, MapPin, Package, QrCode, Landmark, ExternalLink, ShieldCheck, Copy, Check, X, Sparkles } from 'lucide-react';
